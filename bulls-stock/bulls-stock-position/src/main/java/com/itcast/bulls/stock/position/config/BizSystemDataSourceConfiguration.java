...
@Configuration
@MapperScan(basePackages = "com.itcast.bulls.stock.position.dao.biz", sqlSessionTemplateRef  = "bizSystemSqlSessionTemplate")
public class BizSystemDataSourceConfiguration {
    ...
    public SqlSessionFactory bizSystemSqlSessionFactory(@Qualifier("bizSystemDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/itcast/bulls/stock/position/dao/biz/mapper/*Mapper.xml"));
