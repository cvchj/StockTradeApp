...
@Configuration
@MapperScan(basePackages = "com.itcast.bulls.stock.position.dao.trade", sqlSessionTemplateRef  = "tradeSystemSqlSessionTemplate")
public class TradeSystemDataSourceConfiguration {
    ...
    public SqlSessionFactory tradeSystemSqlSessionFactory(@Qualifier("tradeSystemDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/itcast/bulls/stock/position/dao/trade/mapper/*Mapper.xml"));
