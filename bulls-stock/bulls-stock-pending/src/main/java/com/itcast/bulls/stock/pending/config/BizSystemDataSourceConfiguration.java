...
@Configuration
@MapperScan(basePackages = "com.itcast.bulls.stock.pending.dao.biz", sqlSessionTemplateRef  = "bizSystemSqlSessionTemplate")
public class BizSystemDataSourceConfiguration {
    ...
    public SqlSessionFactory bizSystemSqlSessionFactory(@Qualifier("bizProxyDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/itcast/bulls/stock/pending/dao/biz/mapper/*Mapper.xml"));
